...
/**
 * The FOUNDER workshop landing page — Business Transformation Blueprint.
 * Moved here verbatim from app/page.tsx when the HR workshop got its own
 * subdomain; app/page.tsx now picks between this and HrPage by host.
 *
 ...
 */
export default function FounderPage({ ev }: { ev: LandingEvent }) {
  return (
    <>
      <Header />
